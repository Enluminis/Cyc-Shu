...
<div className='flex items-center justify-center bg-white p-4 h-[200px] md:h-[250px]'><img src='data:image/jpeg;base64,' className='max-w-full max-h-full object-contain'></img></div>
...
<div className='flex items-center justify-center bg-white p-4 h-[200px] md:h-[250px]'><img src='https://logo.clearbit.com/prattwhitney.com' alt='Pratt and Whitney' className='max-w-full max-h-full object-contain'></img></div><div className='flex items-center justify-center bg-white p-4 h-[200px] md:h-[250px]'><img src='https://logo.clearbit.com/bmw.com' alt='BMW' className='max-w-full max-h-full object-contain'></img></div><div className='flex items-center justify-center bg-white p-4 h-[200px] md:h-[250px]'><img src='https://logo.clearbit.com/oliverwyman.com' alt='Oliver Wyman' className='max-w-full max-h-full object-contain'></img></div>
</div>
        </>
    )
}
